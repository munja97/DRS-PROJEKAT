...
class SimMoveDemo(QMainWindow):
    ...
    def __init__(self, brojIgraca):
        ...
        self.preprekaSlika = QPixmap('slike\\bare.png')
        self.novcic = QPixmap('slike\\bare.png')
        ...
        self.points3 = QLabel(self)
        self.points33 = QLabel(self)
        ...
        self.points3.setText('P3: ')
        self.points3.setStyleSheet('color: yellow')
        ...
        self.life3ispis.setText('P3 Life: ')
        ...
        self.points33.setText(str(self.poeniPL3))
        self.points33.setStyleSheet('color: yellow')
    ...
    def __init_ui__(self, brojIgraca):
        ...
        self.labelPrepreka.setPixmap(self.preprekaSlika)
        self.label2.setGeometry(300, 300, 50, 100)
     ...
     #   self.labelLifes1.setFont(font)
        ...
        self.points22.setGeometry(110, 110, 100, 100)
        ...
        if (brojIgraca == 3):
            ...
            self.life3ispis.setGeometry(2, 155, 120, 100)
            # self.life2ispis.setFont(font)
            self.labelLifes3.setStyleSheet('color: yellow')
            self.labelLifes3.setGeometry(110, 155, 100, 100)
            # self.labelLifes2.setFont(font)

            self.points3.setGeometry(2, 175, 100, 100)
            self.points33.setGeometry(110, 175, 100, 100)
            # self.points2.setFont(font)
            self.points3.setStyleSheet('color: yellow')
            #  self.points2.setFont(font)
       ...
       # self.preprekaMovement.preprekaMovementSignal.connect(self.movePrepreke())
        ...
        self.coinsMovement.coinsMovementSignal.connect(self.generateForce1)
    ...
    def movePrepreke(self):
        rec = self.labelPrepreka.geometry()
        ...
        if a % 12 == 0:
            ...
            self.prepreke[len(self.prepreke) - 1].setPixmap(self.auto3)
        ...
        for prepreka in self.prepreke:
            ...
            #
            #         if self.lives2 == 0:
            #             self.label2.setGeometry(200, 475, 75, 75)
            #             self.label2.hide()
            #
            #             if self.izgubioPrvi:
    ...
    def generateForce(self):
        ...
        #         self.lives2 = 0
        #         self.labelLifes2.setText(str(self.lives2))
        #         self.label2.setGeometry(200, 40, 75, 75)
        #         self.label2.hide()
        #
        #         if self.izgubioPrvi:
        #             self.kraj = GameOver(2, self.poeniPL2)
        ...
        if isHit(self.heart, self.label3):
            self.lives3 += 1
            self.labelLifes3.setText(str(self.lives3))
            self.heart.hide()
    ...
    def generateForce1(self):
        ...
        if isHit(self.coin, self.label2):
            self.poeniPL2 += 1
            self.points22.setText(str(self.poeniPL2))
            self.coin.hide()

        if isHit(self.coin, self.label3):
            self.poeniPL3 += 1
            self.points33.setText(str(self.poeniPL3))
            self.coin.hide()
